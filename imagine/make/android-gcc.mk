...
ifeq ($(android_stdcxx), gnu)
 android_stdcxxLib := $(ANDROID_NDK_PATH)/sources/cxx-stl/gnu-libstdc++/libs/$(android_abi)/4.6.3/libgnustl_static.a
else
 android_stdcxxLib := $(ANDROID_NDK_PATH)/sources/cxx-stl/stlport/libs/$(android_abi)/4.6.3/libstlport_static.a -lstdc++ -lcrystax -lc -lm $(tcpath)/libgcc_eh.a $(tcpath)/libgcc.a
endif
...
LDLIBS += $(android_ndkSysroot)/usr/lib/crtbegin_so.o -L$(android_ndkSysroot)/usr/lib -lcrystax -lstdc++ -llog -lc -lm $(tcpath)/libgcc_eh.a $(tcpath)/libgcc.a $(android_ndkSysroot)/usr/lib/crtend_so.o  #-lgcc
...
CPPFLAGS += -DANDROID -fPIC --sysroot=$(android_ndkSysroot) -I$(ANDROID_NDK_PATH)/sources/crystax/include -I/Users/quarnster/android/android-toolchain/user/include
